...
- `<CR>` - **For diffs**: Show diff in split view | **For files**: Open file | **Other**: Show details
- `<c-o>` - Open current file state (useful after viewing a diff)
- `<c-x>` - Open file in horizontal split
- `<c-v>` - Open file in vertical split
- Preview pane shows:
  - **For diffs**: Claude's proposed changes
  - **For files**: File contents
  - **Other**: Entry metadata as JSON
